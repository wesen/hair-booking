...
Shared design-language files under ``web/src/admin-dsl/widgets/shared`` are owned
by ``06-generate-admin-dsl-design-language.py``. This scaffold generator never
writes shared files; it only generates widget-local files.

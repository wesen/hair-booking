...
export function Tabs(props: TabsProps) {
  ...
  return (
    <section
      ...
      data-admin-dsl-widget-id={tabsWidgetMetadata.widgetId}
    ...
    >
      <div style={{ border: "1px solid #dfd2bd", borderRadius: 12, padding: 12, background: "#fffaf0" }}>
        ...
        <p style={{ margin: "6px 0 0", fontSize: 12, color: "#6f6254" }}>{tabsWidgetMetadata.purpose}</p>
        {tabsWidgetMetadata.adapterBoundary ? (
          <p style={{ margin: "6px 0 0", fontSize: 12, color: "#6f6254" }}>Adapter: {tabsWidgetMetadata.adapterBoundary}</p>
        ) : null}
        <details style={{ marginTop: 10, fontSize: 12, color: "#6f6254" }}>
          <summary>Widget IR metadata</summary>
          <pre style={{ whiteSpace: "pre-wrap", margin: "8px 0 0" }}>{JSON.stringify(tabsWidgetMetadata, null, 2)}</pre>
        </details>
      </div>

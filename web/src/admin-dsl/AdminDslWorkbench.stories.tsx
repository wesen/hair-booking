...
const navItems: AdminJsonObject[] = [
    {
        ...
        label: "Overview",
        icon: "⌂",
        action: action.mutation("nav.overview", "Overview").placement("sidebarNav").toJSON()
    },
    {
        id: "services",
        label: "Services",
        icon: "▦",
        action: action.mutation("nav.services", "Services").placement("sidebarNav").toJSON()
    },
    {
        id: "calendar",
        label: "Calendar",
        icon: "□",
        action: action.mutation("nav.calendar", "Calendar").placement("sidebarNav").toJSON()
    },
    {
        id: "drafts",
        label: "Drafts",
        icon: "✎",
        action: action.mutation("nav.drafts", "Drafts").placement("sidebarNav").toJSON()
    },
    {
        id: "requests",
        label: "Requests",
        icon: "!",
        action: action.mutation("nav.requests", "Requests").placement("sidebarNav").toJSON()
    },
    {
        id: "media",
        label: "Media",
        icon: "▧",
        action: action.mutation("nav.media", "Media").placement("sidebarNav").toJSON()
    },
    {
        id: "settings",
        label: "Settings",
        icon: "⚙",
        action: action.mutation("nav.settings", "Settings").placement("sidebarNav").toJSON()
    },
    {
        id: "activity",
        label: "Activity Log",
        icon: "↺",
        action: action.mutation("nav.activity", "Activity Log").placement("sidebarNav").toJSON()
    },
];
...
const services: AdminJsonObject[] = [
    {
        id: "svc_cut",
        name: "Cut",
        description: "Trim · restyle · bangs · sort 10",
        status: "published",
        actions: [action.open("service.menu", "Open", {id: "svc_cut"}).placement("rowOverflow").toJSON()]
    },
    {
        id: "svc_highlights",
        name: "Highlights",
        ...
        status: "published",
        actions: [action.open("service.menu", "Open", {id: "svc_highlights"}).placement("rowOverflow").toJSON()]
    },
    {
        id: "svc_gloss",
        name: "Gloss Refresh",
        description: "Tone · shine · maintenance · sort 30",
        status: "draftChanges",
        actions: [action.open("service.menu", "Open", {id: "svc_gloss"}).placement("rowOverflow").toJSON()]
    },
    {
        id: "svc_extensions",
        name: "Extensions",
        description: "Consultation · quote required · sort 40",
        status: "disabled",
        actions: [action.open("service.menu", "Open", {id: "svc_extensions"}).placement("rowOverflow").toJSON()]
    },
];
...
const requestColumns: AdminJsonObject[] = [
    {
        ...
        map: {
            ...
            needsInfo: {label: "Needs info", tone: "danger"},
...
const requestRows: AdminJsonObject[] = [
    {
        ...
        budget: "$220–$380",
        submitted: "4m ago",
        actions: [action.open("request.review", "Review", {id: "req_1001"}).placement("row").toJSON()]
    },
    {
        id: "req_1002",
        status: "needsInfo",
        ...
        budget: "$300+",
        submitted: "22m ago",
        actions: [action.open("request.review", "Review", {id: "req_1002"}).placement("row").toJSON()]
    },
    {
        id: "req_1003",
        status: "approved",
        customer: "Lena Ortiz",
        service: "Gloss refresh",
        budget: "$120",
        submitted: "1h ago",
        actions: [action.open("request.review", "Review", {id: "req_1003"}).placement("row").toJSON()]
    },
];
...
const draftChanges: AdminJsonObject[] = [
    {
        ...
        draft: "$220–$380",
        scheduled: "Jun 23",
        actions: [action.open("draft.review", "Review", {id: "price"}).placement("row").toJSON()]
    },
    {
        id: "availability",
        field: "Highlights – Availability",
        current: "Jun 23 available",
        draft: "Jun 23 disabled",
        scheduled: "Jun 23",
        actions: [action.open("draft.review", "Review", {id: "availability"}).placement("row").toJSON()]
    },
    {
        id: "description",
        field: "Gloss Refresh – Description",
        current: "Tone · shine · maintenance · sort 30",
        draft: "Updated description",
        scheduled: "Jun 28",
        actions: [action.open("draft.review", "Review", {id: "description"}).placement("row").toJSON()]
    },
    {
        id: "copy",
        field: "Cut – Copy",
        current: "Add a few photos",
        draft: "Upload current hair photos",
        scheduled: "Jun 28",
        actions: [action.open("draft.review", "Review", {id: "copy"}).placement("row").toJSON()]
    },
];
...
function targetDashboardPage(): AdminPage {
    return workbench(
        ...
        admin.dashboardGrid({columns: {desktop: 12, tablet: 8, mobile: 1}, gap: "compact", density: "compact"},
            admin.metric("Total Services", 24, {
                caption: "3 draft changes",
                layout: {span: {desktop: 4, tablet: 4, mobile: 1}, order: 10}
            }),
            admin.metric("Upcoming Changes", 2, {
                caption: "Next: Jun 23",
                tone: "warning",
                layout: {span: {desktop: 4, tablet: 4, mobile: 1}, order: 11}
            }),
            admin.metric("Last Published", "Jun 19", {
                caption: "Highlights updated",
                tone: "success",
                layout: {span: {desktop: 4, tablet: 4, mobile: 1}, order: 12}
            }),
            admin.panel("Phase 5 Services", {
                    density: "compact",
                    padding: "none",
                    layout: {span: {desktop: 8, tablet: 8, mobile: 1}, order: 20},
                    footerActions: [action.open("service.new", "Add new service").placement("panelFooter").toJSON()]
                },
                resource.table("services", serviceColumns, services),
            ),
            admin.panel("Calendar", {
                density: "compact",
                layout: {span: {desktop: 4, tablet: 8, mobile: 1}, order: 30}
            }, calendarNode()),
            admin.panel("Draft Changes", {
                density: "compact",
                padding: "none",
                layout: {span: {desktop: 12, tablet: 8, mobile: 1}, order: 40}
            }, admin.comparisonTable("draftChanges", draftChanges)),
            admin.panel("Recent Activity", {
                density: "compact",
                layout: {span: {desktop: 6, tablet: 4, mobile: 1}, order: 50},
                footerActions: [action.open("activity.viewAll", "View all activity").placement("panelFooter").toJSON()]
            }, admin.activityFeed(activityItems)),
            admin.panel("Preview", {
                density: "compact",
                layout: {span: {desktop: 6, tablet: 4, mobile: 1}, order: 60},
                footerActions: [action.open("preview.open", "Open preview").placement("panelFooter").toJSON()]
...
function serviceOpsPage(): AdminPage {
    return workbench(
        ...
        admin.dashboardGrid({columns: {desktop: 12, mobile: 1}, gap: "compact"},
            admin.metric("Published", 18, {
                caption: "Visible to customers",
                tone: "success",
                layout: {span: {desktop: 3, mobile: 1}, order: 10}
            }),
            admin.metric("Draft", 4, {
                caption: "Pending review",
                tone: "warning",
                layout: {span: {desktop: 3, mobile: 1}, order: 11}
            }),
            admin.metric("Disabled", 2, {
                caption: "Hidden services",
                tone: "danger",
                layout: {span: {desktop: 3, mobile: 1}, order: 12}
            }),
            admin.metric("Avg ticket", "$244", {
                caption: "Last 30 days",
                layout: {span: {desktop: 3, mobile: 1}, order: 13}
            }),
            admin.panel("Services", {
                    density: "compact",
                    padding: "none",
                    layout: {span: {desktop: 12, mobile: 1}, order: 20},
                    toolbarActions: [action.secondary("services.export", "Export").placement("panelToolbar").toJSON()],
                    footerActions: [action.open("service.new", "Add service").placement("panelFooter").toJSON()]
                },
                resource.table("services", serviceColumns, services),
            ),
        ),
...
function requestTriagePage(): AdminPage {
    return workbench(
        ...
        admin.dashboardGrid({columns: {desktop: 12, mobile: 1}, gap: "compact"},
            admin.panel("Today’s queue", {
                    density: "compact",
                    padding: "none",
                    layout: {span: {desktop: 8, mobile: 1}, order: 10}
                },
                resource.table("requests", requestColumns, requestRows, {
                    bulkLabel: "3 visible requests",
                    bulkActions: [action.secondary("requests.bulkAssign", "Assign").placement("bulkToolbar").toJSON()]
                }),
            ),
            admin.panel("Queue health", {density: "compact", layout: {span: {desktop: 4, mobile: 1}, order: 20}},
                ...
                admin.kvList([{label: "Oldest new", value: "22m"}, {
                    label: "Photos missing",
                    value: "2"
                }, {label: "Ready to book", value: "5"}]),
            ),
        ),
    );
}
...
function draftReviewPage(): AdminPage {
    return workbench(
        ...
        admin.dashboardGrid({columns: {desktop: 12, mobile: 1}, gap: "compact"},
            admin.panel("Scheduled changes", {
                    density: "compact",
                    padding: "none",
                    layout: {span: {desktop: 9, mobile: 1}, order: 10}
                },
                admin.comparisonTable("draftChanges", draftChanges)),
            admin.panel("Publish summary", {
                    density: "compact",
                    layout: {span: {desktop: 3, mobile: 1}, order: 20},
                    footerActions: [action.danger("draft.discard", "Discard draft").placement("panelFooter").toJSON()]
                },
                admin.metric("Changed fields", draftChanges.length, {tone: "warning", caption: "Across 3 services"}),
                admin.kvList([{label: "Next publish", value: "Jun 23"}, {
                    label: "Reviewer",
                    value: "Admin User"
                }, {label: "Validation", value: "Passing"}]),
            ),
        ),
    );
}
...
function calendarPublishingPage(): AdminPage {
    return workbench(
        ...
        admin.dashboardGrid({columns: {desktop: 12, mobile: 1}, gap: "compact"},
            admin.panel("June 2024", {
                density: "compact",
                layout: {span: {desktop: 5, mobile: 1}, order: 10}
            }, calendarNode("publishingMonth")),
            admin.panel("Selected date", {density: "compact", layout: {span: {desktop: 7, mobile: 1}, order: 20}},
                admin.comparisonTable("dateChanges", [
                    {
                        id: "jun23-availability",
                        field: "Jun 23 availability",
                        current: "Open",
                        draft: "Disabled",
                        scheduled: "Jun 23",
                        actions: [action.open("date.review", "Review").placement("row").toJSON()]
                    },
                    {
                        id: "jun23-copy",
                        field: "Booking copy",
...
function editorWorkbenchPage(): AdminPage {
    return workbench(
        ...
        admin.dashboardGrid({columns: {desktop: 12, mobile: 1}, gap: "compact"},
            admin.panel("Service basics", {
                    density: "normal",
                    layout: {span: {desktop: 7, mobile: 1}, order: 10},
                    footerActions: [action.primary("service.save", "Save").placement("panelFooter").toJSON(), action.secondary("service.cancel", "Cancel").placement("panelFooter").toJSON()]
                },
                admin.form("serviceForm", {title: "Highlights", dirty: true},
                    admin.fieldGroup("Identity",
                        ...
                        field.select("status", [{label: "Published", value: "published"}, {
                            label: "Draft",
                            value: "draft"
...
function emptyAndErrorsPage(): AdminPage {
    return workbench(
        ...
        admin.dashboardGrid({columns: {desktop: 12, mobile: 1}, gap: "compact"},
            admin.panel("No draft changes", {
                density: "compact",
                layout: {span: {desktop: 4, mobile: 1}, order: 10}
            }, admin.emptyState("No draft changes", {body: "Create a draft to stage service updates."})),
            admin.panel("Loading requests", {
                density: "compact",
                layout: {span: {desktop: 4, mobile: 1}, order: 20}
            }, admin.loadingState("Loading queue", {body: "Fetching the latest intake requests."})),
            admin.panel("Config error", {
                density: "compact",
                layout: {span: {desktop: 4, mobile: 1}, order: 30}
            }, admin.inlineError("Config validation failed", {body: "A required service label is missing."})),
        ),
    );
}
...
function WorkbenchStory({page}: { page: AdminPage }) {
    return <AdminPageRenderer page={page}
                              context={{dispatch: (event) => console.log("workbench story event", event)}}/>;
}
...
export const ServiceOperations: Story = {
    args: {page: serviceOpsPage()},
    parameters: {viewport: {defaultViewport: "desktop"}}
};
export const RequestTriage: Story = {
    args: {page: requestTriagePage()},
    parameters: {viewport: {defaultViewport: "desktop"}}
};
export const DraftReviewQueue: Story = {
    args: {page: draftReviewPage()},
    parameters: {viewport: {defaultViewport: "desktop"}}
};
export const CalendarPublishing: Story = {
    args: {page: calendarPublishingPage()},
    parameters: {viewport: {defaultViewport: "desktop"}}
};
export const TypedFormWorkbench: Story = {
    args: {page: editorWorkbenchPage()},
    parameters: {viewport: {defaultViewport: "desktop"}}
};
export const EmptyLoadingErrorStates: Story = {
    args: {page: emptyAndErrorsPage()},
    parameters: {viewport: {defaultViewport: "desktop"}}
};
export const AuditWorkbench: Story = {
    args: {page: auditWorkbenchPage()},
    parameters: {viewport: {defaultViewport: "desktop"}}
};
export const DenseMobileOperations: Story = {
    args: {page: requestTriagePage()},
    parameters: {viewport: {defaultViewport: "iphone14"}}
};

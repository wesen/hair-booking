...
func NewHandler(options HandlerOptions) http.Handler {
	...
	mux.HandleFunc("GET /api/me/appointments", h.handleMyAppointments)
	mux.HandleFunc("GET /api/me/appointments/{id}", h.handleMyAppointmentDetail)
	mux.HandleFunc("PATCH /api/me/appointments/{id}", h.handleMyAppointmentReschedule)
	mux.HandleFunc("POST /api/me/appointments/{id}/cancel", h.handleMyAppointmentCancel)
	mux.HandleFunc("GET /api/me/maintenance-plan", h.handleMyMaintenancePlan)

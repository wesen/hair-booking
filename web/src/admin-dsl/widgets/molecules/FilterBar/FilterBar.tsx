...
export function FilterBar(props: FilterBarProps) {
  ...
  return (
    <section
      ...
      data-admin-dsl-widget-id={filterBarWidgetMetadata.widgetId}
    ...
    >
      <div style={{ border: "1px solid #dfd2bd", borderRadius: 12, padding: 12, background: "#fffaf0" }}>
        ...
        <p style={{ margin: "6px 0 0", fontSize: 12, color: "#6f6254" }}>{filterBarWidgetMetadata.purpose}</p>
        {filterBarWidgetMetadata.adapterBoundary ? (
          <p style={{ margin: "6px 0 0", fontSize: 12, color: "#6f6254" }}>Adapter: {filterBarWidgetMetadata.adapterBoundary}</p>
        ) : null}
        <details style={{ marginTop: 10, fontSize: 12, color: "#6f6254" }}>
          <summary>Widget IR metadata</summary>
          <pre style={{ whiteSpace: "pre-wrap", margin: "8px 0 0" }}>{JSON.stringify(filterBarWidgetMetadata, null, 2)}</pre>
        </details>
      </div>
